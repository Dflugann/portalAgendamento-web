...
@section('corpo')
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Cadastro Condominos</h5>
            <!--<p class="light">Cadastro para novos moradores</p>-->
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Cadastro Visitantes</h5>
            <!--<p class="light"></p>-->
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Configuração</h5>
            <!--<p class="light"></p>-->
          </div>
        </div>
      </div>
  ...
  <div class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
      <div class="container">
        <div class="row center">
          <h5 class="header col s12 light">Todas as rotinas de administração de condomínios são facilmente gerenciadas com total facilidade</h5>
        </div>
      </div>
    </div>
